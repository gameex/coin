                        ...
                        <?php foreach($models as $model){ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-id="<?=$model->id?>" data-name="<?=$model->real_name?>" data-type="<?=$auth?>" data-status="<?=$model->status?>" data-img="<?=$model->id_card_img?>" data-img2="<?=$model->id_card_img2?>" data-toggle="modal" data-target="#myModal" class="real_name"><span class="btn btn-info btn-sm"><?=$auth == 'operated' ? '查看' : '审核';?></span></a>&nbsp;

...
class TransactionController extends MController
{
    ...
    public function actionIndex()
    {
        ...
        // 判断是否追加查询条件
        $db = new \yii\db\Query;
        $data = $db->select('t.id,t.type,t.member_id,t.tx_hash,t.from,t.to,t.coin_symbol,t.value_dec,t.tx_status,t.block,t.updated_at,t.rpc_response,m.nickname')->from('jl_transaction t');
        $where[]='and';
    ...
    protected function findModel($id)
    {
        ...
        if (empty($model = Transaction::findOne($id))) {
            return new Transaction();
        }

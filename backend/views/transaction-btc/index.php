                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($models as $model){ ?>
                            <tr>
                                ...
                                <td>
                                    <?= $model['tx_hash'] ? \yii\helpers\Html::a($model['tx_hash'],['main/redirect','url'=>'https://www.blockchain.com/en/btc/tx/'.$model['tx_hash']], ['target'=>'_blank']) : 'fail reason: '.$model['rpc_response'] ?>
                                </td>
                                <td title="<?= $model['from']?>">
                                    <?= \yii\helpers\Html::a($model['member_id'].' / '.$model['nickname'], ['main/redirect','url'=>'https://www.blockchain.com/en/btc/address/'.$model['from']], ['target'=>'_blank']) ?>
                                </td>
                                <td>
                                    <?= \yii\helpers\Html::a($model['to'], ['main/redirect','url'=>'https://www.blockchain.com/en/btc/address/'.$model['to']], ['target'=>'_blank']) ?>
                                </td>

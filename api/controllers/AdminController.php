...
class AdminController extends ApibaseController{
    ...
    public function actionAdd(){
        ...
        $memo = $params['memo'];
        $result = $this->add_transfer_log($coin_symbol,$from_address,$to_address,$wallet_memo,$memo,$amount,$blockhash,$txid);
        if (!empty($result)) {
            die($result);
        }
        die('success');

	...
	<div class="main">
		...
		<div class="choice">
				...
				<div class="regCheck">
					...
					<i class="check_bg"></i>
					<label for="checkcodes"><font data-i18n="u_h_54">I have read the above risk tips carefully and have agreed with this site </font>
						<a href="/help/14" data-i18n="u_h_55">Terms of use</a>，
						<a href="/help/13" data-i18n="u_h_56">Privacy policy</a>，
						<a href="/help/15" data-i18n="u_h_57">Anti-Money Laundering Ordinance</a>
						<font data-i18n="u_h_58">To agree to participate in the transaction at their own risk and at their own expense.</font>
					</label>
				</div>
				<div class="regCheck">
					<input type="checkbox" class="checkcodes" name="risk" >
					<i class="check_bg"></i>
					<label for="checkcodes" data-i18n="u_h_59">I am neither an American nor a Singaporean.</label>
				</div>
				<div class="register">
					<!--<input class="registerbtn" value="继续注册" type="submit" disabled="disabled">-->
					<a href='javascript:;' class="registerbtn">Continue to register</a>
					<a href="./index" class="cancelbtn" data-i18n="b_42">cancel</a>
				</div>
		</div>
	</div>

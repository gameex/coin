	...
	<div class="main_box">
		<div class="trade-responsive ivu-col ivu-col-span-xs-24 ivu-col-span-lg-14 ybc_list"><!----> 
			<ul class="ul_select" style="margin-top: 40px;">
				<li class="li_select">
					<label data-i18n="u_c_2" class="ChooseType">Buy</label>
					<div id="mySelect_1">
				...
				<li class="li_select">
					<label data-i18n="u_c_4" class="ChooseType">Sell</label>
					<div id="mySelect_3">
						<div class="filter-text">
							<input class="filter-title filter-int" type="text" readonly="" placeholder="全部">
            ...
            <div class="trade-content" style="margin-top: 25px;">
            	<div class="table-list font14 font-gray">
            		<span class="user" style="width:18%;">Businessmen (30-day order | 30-day completion rate)</span> 
            		<!-- <span class="user credit">数量</span>  -->
            		<span class="user limit">Quota</span> 
            		<span class="user price" style="border:0;height:auto;">Price</span> 
            		<div class="user operation">
            			<p class="spec">
            				<span class="payways">Payment method</span>
            				<span style="display: inline-block;width: 80px;text-align: center;">operation</span>
            			</p>
            		</div>
            	</div> 

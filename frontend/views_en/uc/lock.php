...
<div id="main">
    <div class="main_box">
        ...
        <div class="assets_content w950 right bg_w" id="safebox" style=" border-left-style:none!important;">
        	<h1 data-i18n="u_a_2">Basic information</h1>
            <div class="safe_center clear">
	            <div>               
                    <dl class="dls">
                        ...
                        <dd class="WS_name"><span>Name：</span><span data-i18n="u_a_3" style="width:100px;" class="data_s"></span>
                            <a href="/uc/verified" class="margin" data-i18n="u_a_26" style="opacity:0;">Certification</a>
                        </dd>
                        <dd class="WS_tele"><span>Phone number：</span><span data-i18n="u_a_4" class="data_s"> </span>
                            <a href="/uc/bindphone" class="margin" data-i18n="u_a_28" >Binding phone</a>
                            </dd>

                        <dd class="WS_email"><span>Email：</span><span data-i18n="u_a_5" class="data_s"></span>
                            <a href="/uc/bindemail" class="margin" data-i18n="u_a_28" >Binding email</a>
                        </dd>
                        <dd class="WS_nike"><span>Name:</span>
                            <input type="text" placeholder="Please enter name" class="niname" id="ninames" value="" maxlength="20">
                            <button class="modify" data-i18n="u_a_7">Modification</button>
                        </dd>
                    </dl>
                </div>
                <div style="float:left; margin-left:70px;position: relative;">
                    <dl style=" padding-top:0px !important;color: #333;" class="dls">
                        <dd>
                            <font data-i18n="u_f_31">After authentication, the daily cash withdrawal can be increased to 10 BTC. </font>
                            <a href="/uc/verified" data-i18n="u_a_26" class="ws_Real">Certification</a>
                        </dd>                       
                        ...
                        <dd style="display: none;">Main station：　<em class="em_color">data-i18n="u_b_4"&gt;About ￥ 0 </em>Main plate：<em class="em_color">data-i18n="u_b_4"&gt;About ￥0</em></dd>
                    </dl>
                </div>
            </div>
            <ul class="sc_statu">
                <li>
                    ...
                    <dl>
                        <dt data-i18n="u_a_14">Identity authentication</dt>
                        <dd class="s-verify">
                        	<font data-i18n="u_f_29">Uncertified</font>
                        	<a href="/uc/verified" data-i18n="u_f_30">Click authentication</a>
                        </dd>
                    </dl>
                </li>
                <li>
                    <em class="sc_statu_type_1_1"></em>
                    <dl>
                        <dt data-i18n="u_a_14">Email binding</dt>
                        <dd class="s-email">
                            <font data-i18n="u_f_29">Uncertified</font>
                            <a href="/uc/bindemail" data-i18n="u_f_30">Click authentication</a>
                        </dd>
                    </dl>
                </li>   
                <li>
                    <em class="sc_statu_type_1_1"></em>
                    <dl>
                        <dt data-i18n="u_a_14">Phone binding</dt>
                        <dd class="s-phone">
                            <font data-i18n="u_f_29">Uncertified</font>
                            <a href="/uc/bindphone" data-i18n="u_f_30">Click authentication</a>
                        </dd>
                    </dl>
                </li>                               
            </ul>

        ...
        <div class="raise right bg_w clearfix" >
	 	...
	 	<?= $article ?>
           ...
           <div class="tagContent selectTag" id="tagContent0">
            		<div><h3 style="padding:20px 20px;">Exchange area</h3></div>
            		
            	
            		<div style="padding:20px 20px;"><span>available <text class="money"><?= sprintf("%.2f",$btc['balance'])  ?></text> <text class="coin_name">BTC</text> = <text class="pacanum">0</text>&nbsp;PAPC</span></div> 
            		 <div style="padding:20px 20px;position:relative;width:470px;">
	            		...
	            		<input class="coin_num" type="text" placeholder="Quantity"  style="border:1px solid black;height:28px;margin-bottom:3px;width:250px;">
	            		<input class="all" type="button" value="All" style="padding:7px 10px;position:absolute;right:86px;background:#008ee6"  >
            		</div> 
            		 <button class="submit-btn" style="margin-left:187px;margin-top:40px;margin-bottom:20px;width:240px;background:#008ee6;border:none;padding:10px 0">Redeem now</button>
           </div>
	 
          <span  style="position:absolute;right:70px;bottom:190px;font-size:20px;">Current exchange rate&nbsp;<text class="cur_rate">0</text></span>

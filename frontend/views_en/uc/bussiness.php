                ...
                $(".button").click(function(){
                    if(img!='' && video != ''){
                        ...
                        $.ajax({
                            ...
                            type:"POST",
                            data:{"access_token":token,image:img,video:video,describe:'Describe'},
                            success : function(result) {
                                result = $.parseJSON(result)
                                console.log(result)
                                if(result.code == 200){
                        ...
                        if(img==''){
                            Toast('Upload pictures can not be empty',2000);
                        }else if(video == ''){
                            Toast('Upload video cannot be empty',2000);
                        }else{
                            Toast('Please fill in the complete information.',2000);
                        }
                    }
                });
    ...
    <div id="box">
        <div class="content">
            ...
            <div class="imgContent">
                ...
                <p class="captureDsc" style="padding-bottom: 0;">1.Hold the front of the ID card, record the video, and keep the sound and image clear during the recording process.</p>
                <p class="captureDsc">2.Video recitation model: I (name), ID card number, legal and reliable source of funds, voluntary trading of digital assets such as Bitcoin, I fully understand the digital currency and potential risks, I have the ability to resist risks and willing to bear all risks!</p>
            </div>

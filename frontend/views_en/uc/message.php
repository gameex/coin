	...
	<?php echo $this->render('left.php'); ?>
        <div class="raise right bg_w clearfix" id="changepwd">
            <div class="message" style="padding-bottom:65px;">
                <p class="messagetab"><a href="javascript:void(0)" class="current" data-i18n="u_g_32">System message</a>
			...
			<div class="allpage" id="Page" style="display: none;">
				...
				<div class="jumpbtn">							
					...
					<div class="jumpchoice">
						<font data-i18n="c_29">Jump to</font><input type="text" id="choicePage" value=""><font data-i18n="c_24">page</font>&nbsp;<button id="jumpPage" data-i18n="c_30">Jump</button>
					</div>
				</div>
			</div>
        </div>

	...
	<div class="raise right bg_w clearfix">
            <div class="ybc_list">
				<div class="ybcoin clearfix">
					<h2 class="left" data-i18n="u_c_1">Financial Journal</h2>
				</div>
					...
					<li class="li_select">
						...
						<div id="mySelect_1">
							...
							<ul class="filter-list coin_symbol" style="">
								<li class="filter-selected" data-value="0"><a title="Whole">Whole</a></li>
							</ul>
						</div>
					</li>

					<li class="li_select sure" style="width:140px;height:38px;background:#368AE5;color:#ffffff;text-align: center;line-height: 38px;font-size: 16px;cursor: pointer;margin-right: 0;margin-left:13px;border-radius: 4px;">Confirm</li>
				</ul>
				<div class="raise_list">
					<table  style="width:100%;" id="Transaction" align="center" border="0" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th data-i18n="u_c_3">Type</th>
								<th data-i18n="u_c_2">Currency</th>
								<th data-i18n="u_c_5">Money</th>
								<th data-i18n="u_c_6">Time</th>
							</tr>
						</thead>
						<tbody id="finlist">

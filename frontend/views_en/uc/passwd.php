            			...
            			<form id="signupForm" method="POST">
                			<ul class="ybc_con" style="margin-left: 50px;">
                    	     	...
                    	     	<li style="margin:30px 60px;;">
		                        	<label class="buys">&nbsp;</label><input style="width:295px;" name="pwd" id="pwd" type="text" placeholder="Please fill in the purchase code" >

		                        </li>

		                        <li style="margin-left:60px;margin-bottom:30px;">
		                        	<label class="buys">&nbsp;</label><input  class="tijiao" data-i18n="u_f_7" value="Submission" type="submit" id="tijiao"></input>
		                        </li>
		                    </ul>
            			</form>
        			</div>

...
<div id="main">
    <div class="main_box">
		...
		<div class="raise right bg_w clearfix" id="changepwd">
    		<h2 data-i18n="u_a_21">Binding phone</h2>
    			...
    			<div id="tagContent" class="passContent">
        			<div class="tagContent selectTag" id="tagContent0">
            			<form id="signupForm">
                    		...
                    		<li>
		                        	<label for="phone">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">Phone(+86)</font>：</label>
		                        	<input name="phone" id="phone" type="text" placeholder="Please enter your phone number">
		                        </li>
				            <li>
					        <label for="codes" data-i18n="u_h_14">Captcha</label>
					          	<input name="mjcode" id="mjcode" value="" type="text" maxlength="6" placeholder="Enter the captcha" style="width:150px;">
				            	<?php 
		                        ...
		                        <li>
		                        	<label for="newword"><font data-i18n="u_f_5">Mobile code</font>：</label>
									<input type="text" placeholder="Enter your phone number" name="varcode" id="varcode" class="code" value="" style="width: 150px;"/>
                    			...
                    			<li>
		                        	<label for="passwd">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">login password</font>：</label>
		                        	<input name="passwd" id="passwd" type="password" placeholder="Please enter your login password">
		                        </li>
		                        <li>
...
<script type="text/javascript">
	...
	if (mjcode == "") {
		...
		user_name = $('#phone').val();
		if (user_name == "") {
			alert_msg('Enter your phone number.');
			$('#phone').focus();
			return;
		}

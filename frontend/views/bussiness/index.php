    ...
    <div id="box">
        <div class="content">
            ...
            <div class="imgContent">
                ...
                <p class="captureRequire">截图要求</p>
                <p class="captureDsc">本人实名银行卡余额或虚拟币资产截图，或对应银行卡一个月的银行流水截图。</p>
            </div>
            <p class="imgTitle">请上传录制视频</p>
            <div class="imgContent">
                ...
                <p class="captureRequire">视频要求</p>
                <p class="captureDsc" style="padding-bottom: 0;">1.手持身份证正面，进行视频录制，保持录制过程中声音和影像都清晰。</p>
                <p class="captureDsc">2.视频诵读范本：本人（姓名），身份证号（身份证号码），我的资金来源合法可靠，自愿交易比特币等数字资产，本人充分了解数字货币及潜在风险，本人具有抗风险的能力并愿意承担一切风险！</p>
            </div>

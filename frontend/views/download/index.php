...
<div id="main">
	<ul class="download">
		<li class="img_list">
			<div class="up_view">
				<div class="up_sdk">
					<h2 data-i18n="u_g_36"><?= Yii::$app->config->info('WEB_APP_NAME') ?> APP</h2>
					<ul class="clearfix">
						<li>
							<img src="<?= Yii::$app->config->info('APP_QRCODE_DOWNLOAD') ?>">
							<p data-i18n="u_g_76"></p>
						</li>
					</ul>
				</div>
			</div>
		...
		<li class="img_list2">
			<div class="up_view02">
				...
				<h2><font data-i18n="u_g_40">随时随地</font><br><font data-i18n="u_g_41">观察行情变化</font></h2>
			</div>
		</li>
		<li class="img_list3">
			<div class="up_view03">
				<img src="/resource/frontend/img/Group_c@2x.png">
				<h3><font data-i18n="u_g_42">每分每秒</font><br><font data-i18n="u_g_43">交易赚钱</font></h3>
			</div>
		</li>
	</ul>
</div>
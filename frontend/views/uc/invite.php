        ...
        <div class="raise right bg_w clearfix" >
            <div class="ybc_list">
                <div class="ybcoin clearfix">
                    <h2 class="left" data-i18n="u_c_1">邀请好友</h2>
                </div> 
                <div class="link-target">
                <ul>
                <li>
                <span class="link"></span>
                <button class="wl-btn link-btn copy-text">复制邀请链接</button>
                </li>
                <li>
                <span class="code"></span>
                <button class="wl-btn code-btn copy-text">复制邀请码</button>
                </li>
                </ul>
                </div>
                ...
                <div class="referer-lead">
                    ...
                    <thead>
                    <tr height="40">
                    <th class="header" width="190">排名</th>
                    <th class="header" width="380">达人</th>
                    <th class="header" width="200">获得奖励/<span class="coin_symbol"></span></th>
                    </tr>
                    </thead>
                    <tbody >

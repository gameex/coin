		                ...
		                <form id="signupForm"  enctype="multipart/form-data">
		                    <ul class="ybc_con" style="margin-left: 50px;">
		                        <li>
		                        	...
		                        	<label for="password">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">姓名</font>：</label>
		                        	<input name="oldpwd" id="oldpwd" type="text" placeholder="请输入真实姓名">
		                        	<i class="tishi" id="oldpwdmsg"></i>
		                        </li>
		                        <li>
		                        	<label for="newword"><font data-i18n="u_f_5">身份证号</font>：</label>
		                        	<input name="pwd" id="pwd" type="text" placeholder="请输入身份证号">
		                    ...
		                    <input class="tijiao" value="保存" type="button" id="save" style="width:200px;height:40px;position: absolute;bottom: 30px;left:30%"></input>
		                </form>
		            </div>
					<div class="clear"></div>
				</div>
        ...
        function bandEvent() {
        	http.post('user/get-info', {
				...
				if(res.data.status == 3){
					if(res.data.status_msg == "审核未通过,请上传真实信息"){
						http.info("审核未通过,请重新认证信息");

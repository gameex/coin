        			...
        			<div class="tagContent selectTag" id="tagContent0">
            			<form id="signupForm">
                			<ul class="ybc_con" style="margin-left: 50px;">
                    			<li>
		                        	<label for="email">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">邮箱地址</font></label>
		                        	<input name="email" id="email" type="text" placeholder="请输入邮箱地址">
		                        </li>
		                     <!--
				            <li>
					        <label for="codes" data-i18n="u_h_14">校验码</label>
					          	<input name="ejcode" id="ejcode" value="" type="text" maxlength="6" placeholder="请输入验证码" style="width:150px;">
				            	<?php 
				            		echo Captcha::widget(['name'=>'captchaimg','captchaAction'=>'reg/captcha','imageOptions'=>['id'=>'captchaimg2', 'title'=>'换一个', 'alt'=>'换一个', 'style'=>'cursor:pointer;'],'template'=>'{image}']); ?>
                              </li> -->                               
		                        <li>
		                        	<label for="newword"><font data-i18n="u_f_5">邮箱验证码</font></label>
									<input type="text" placeholder="请输入邮箱验证码" name="varcode" id="varcode" class="code" value="" style="width: 150px;"/>
                    			...
                    			<li>
		                        	<label for="passwd">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">当前账户密码</font></label>
		                        	<input name="passwd" id="passwd" type="password" placeholder="请输入当前账户密码">
		                        </li>

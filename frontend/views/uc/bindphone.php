        			...
        			<div class="tagContent selectTag" id="tagContent0">
            			<form id="signupForm">
                			<ul class="ybc_con" style="margin-left: 50px;">
                    			<li>
		                        	<label for="phone">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">手机号码(+86)</font></label>
		                        	<input name="phone" id="phone" type="text" placeholder="请输入手机号码">
		                        </li>
		                        <!--
                            <li>
					        <label for="codes" data-i18n="u_h_14">校验码</label>
					          	<input name="mjcode" id="mjcode" value="" type="text" maxlength="6" placeholder="请输入验证码" style="width:150px;">
				            	<?php 
		                        ...
		                        <li>
		                        	<label for="newword"><font data-i18n="u_f_5">手机验证码</font></label>
									<input type="text" placeholder="请输入手机验证码" name="varcode" id="varcode" class="code" value="" style="width: 150px;"/>
                    			...
                    			<li>
		                        	<label for="passwd">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">账户登录密码</font></label>
		                        	<input name="passwd" id="passwd" type="password" placeholder="请输入账户登录密码">
		                        </li>
		                        <li>

        ...
        <div class="raise right bg_w clearfix" >
            <div class="ybc_list">
                <div class="ybcoin clearfix">
                    <h2 class="left" data-i18n="u_c_1">在售矿机</h2>
                </div> 
                <div class="referer-lead">
                    ...
                    <th class="header" width="190">收益</th>
                ...
                <div class="ybcoin clearfix">
                    <h2 class="left" style="color: #e65f46;">我的矿机</h2>
                </div> 
                <div class="referer-lead">
                    ...
                    <th class="header" width="280">算力</th>
                ...
                <div class="ybcoin clearfix">
                    <h2 class="left" style="color: #fba000;">理财记录</h2>
                </div> 
                <div class="referer-lead">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //rank
        http.post('user/weathpackage', {
        }, function(res) {
            List = res.data;
            var rank_index = 0;
            $.each(List, function(index,r) {
                 rank_index = index +1 ;
                 $('.weathpackage').append('<tr height="74"><td>'+ r.name +'</td><td>'+ toNonExponential(r.day_profit) +'%</td><td>类型：'+ r.type +'<br />有效期：'+ r.period +' 天<br />价格：'+ toNonExponential(r.min_num) + r.coin_symbol+'</td><td><a style="color: #0770f6; font-weight: bold;" href="/uc/wealthbuy?id='+ r.id +'">购买</a></td></tr>');
            });
        });

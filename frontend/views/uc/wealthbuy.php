        			...
        			<div class="tagContent selectTag" id="tagContent0">
            			<form id="signupForm">
                			<ul class="ybc_con" style="margin-left: 50px;">
                    			<li>
		                        	<label for="email">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">币种：</font></label>
		                        	<input name="email" id="email" type="text" readonly="readonly" value="<?= $wealtdetail['coin_symbol'] ?>">
		                        </li>
                    			<li>
		                        	<label for="email">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">名称：</font></label>
		                        	<input name="email" id="email" type="text" readonly="readonly" value="<?= $wealtdetail['name'] ?>"> 天
		                        </li>
                    			<li>
                    			<li>
		                        	<label for="email">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">有效期：</font></label>
		                        	<input name="email" id="email" type="text" readonly="readonly" value="<?= $wealtdetail['period'] ?>">
		                        </li> 
                    			<li>
		                        	<label for="email">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">日收益：</font></label>
		                        	<input name="email" id="email" type="text" readonly="readonly" value="<?= $wealtdetail['day_profit'] ?>">%
		                        </li>
                    			<li>
		                        	<label for="email">&nbsp;&nbsp;&nbsp;<font data-i18n="u_f_4">购买额度：</font></label>
